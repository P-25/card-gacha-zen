...
export default function DrawScreen({ onContinue, rewards }: DrawScreenProps) {
  return (
      ...
      <div className="relative z-10 w-full max-w-md h-full max-h-[90%] flex flex-col items-center">
        ...
        >
          <motion.h1
            ...
            className="relative z-10 text-6xl font-black italic tracking-wider text-[#525252] drop-shadow-sm uppercase"
            style={{
        ...
        >
          <Image
            src="/assets/summon/dragon-wake.webp"
            alt="Draw Dragon"
            fill
            className="object-contain drop-shadow-2xl absolute mt-[20px]"
            priority
          />
        </motion.div>
        ...
        >
          ...
          <div className="flex justify-center gap-4 w-full mt-2">
            ...
            {(!rewards || (rewards.exp === 0 && rewards.gold === 0)) && (
        ...
        >
          <button
            onClick={onContinue}
            className="w-full bg-[#525252] hover:bg-[#737373] text-white font-black text-xl py-4 rounded-2xl border-b-[6px] border-[#262626] shadow-xl active:scale-95 active:border-b-0 active:translate-y-1 transition-all uppercase tracking-wider"
          >
            Continue
          </button>
        </motion.div>
